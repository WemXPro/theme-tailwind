            ...
            <div class="flex items-center justify-center px-4 py-6 lg:py-0 sm:px-0">
                ...
                <form method="POST" action="{{ route('login.authenticate') }}" class="w-full max-w-md space-y-4 md:space-y-6 xl:max-w-xl">
                    ...
                    <div>
                        ...
                        <label for="username"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{!! __('auth.email_or_username') !!}</label>
                    ...
                    <div>
                        <label for="password"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{!! __('auth.password') !!}</label>
