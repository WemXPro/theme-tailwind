        ...
        <form method="POST" action="#">
            ...
            <div class="grid gap-5 my-6 sm:grid-cols-1">
                <div>
                    ...
                    <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{!! __('auth.your_username') !!}</label>
            ...
            <div class="grid gap-5 my-6 sm:grid-cols-1">
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{!! __('auth.your_email') !!}</label>
