...
@section('content')
    <div class="w-full">
        ...
        <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
            class="mt-2 text-primary-600 dark:text-primary-500 font-bold">
            {!! __('Change Email') !!}
        </button>
        <!-- Main modal -->
            ...
            <div class="relative p-2 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-2 border-b rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                            class="end-1 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-6 h-6 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    ...
                    <!-- Modal body -->
                    <div class="p-2 mb-2">
                        <form class="space-y-2" action="{{ route('verification.change-email') }}" method="POST">
                            @csrf
                            <div class="mb-2"> <!-- Set margin-bottom to 0 -->
                                <label for="new_email"
                                    class="block text-sm font-medium mb-2 text-gray-900 dark:text-white">New
                                    Email</label>
                            ...
                            <button type="submit"
                                class="w-full text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                Change Email
                            </button>
                        </form>
                    </div>
