...
@section('container')
    <div class="flex flex-wrap">
        ...
        <div class="w-full pl-2 pr-2 @if(widgets('dashboard')->isNotEmpty()) sm:w-1/2 md:w-2/3 lg:w-2/3 @endif">
                        ...
                        <div
                            ...
                            <div class="flex w-full flex-row items-center justify-end space-x-3">
                                ...
                                <div id="filterDropdown"
                                     ...
                                     style="position: absolute; inset: 0 auto auto 0; margin: 0; transform: translate(1222px, 84px);">
                                    ...
                                    <tr class="hidden w-full flex-1 overflow-x-auto"
                                        ...
                                        <td class="border-b p-4 dark:border-gray-700" colspan="9">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex items-center text-gray-500 dark:text-gray-400">
                                                                <span
                                                                    ...
                                                                    {{ price($order->price['renewal_price']) }}</span>
                                                        / {{ $order->periodToHuman() }}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-4 flex items-center space-x-3">
                                                @include(Theme::path('components.orders.buttons', ['order' => $order]))
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
