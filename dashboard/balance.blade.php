                            ...
                            @foreach (auth()->user()->balance_transactions()->latest()->paginate(15) as $transaction)
                                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="pl-3">
                                            <div
                                                class="text-base font-semibold">{{ $transaction->created_at->translatedFormat('d M Y') }}</div>
                                            <div
                                                class="font-normal text-gray-500">{{ $transaction->created_at->diffForHumans() }}</div>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
