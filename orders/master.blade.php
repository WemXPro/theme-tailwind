                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('service', ['order' => $order->id, 'page' => 'members']) }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 {{ is_active('service', ['order' => $order, 'page' => 'members'], 'bg-gray-100 dark:bg-gray-700') }}">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">{!! __('client.members') !!}</span>
                        </a>
                    </li>
